...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Laporan Pengajuan Peserta Magang</p>
        <ol class="breadcrumb breadcrumb-transparent mb-0">
            <li class="breadcrumb-item">
                <a href="/dashboard">Dashboard</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Laporan Pengajuan Peserta Magang
            </li>
        </ol>
    </div>
    <div class="w-100 p-2">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = DataTableGenerator('#table-data', '/laporan-pengajuan/data', [
                {data: 'DT_RowIndex', name: 'DT_RowIndex', searchable: false, orderable: false},
                {data: 'tanggal'},
                {data: 'no_pengajuan'},
                {data: 'user.peserta.nama'},
                {data: 'user.peserta.sekolah'},
                {data: 'bagian.nama'},
                {data: 'tanggal_mulai'},
            ...
            $('#btn-cetak').on('click', function (e) {
                ...
                let tgl1 = $('#tgl1').val();
                let tgl2 = $('#tgl2').val();
                window.open('/laporan-pengajuan/cetak?tgl1=' + tgl1 + '&tgl2=' + tgl2, '_blank');
            })
        });
    </script>
@endsection

...
class PesertaController extends CustomController
{
    ...
    {
        $data = User::with(['peserta.divisi'])->where('role', '=', 'peserta')->get();
    ...
    {
        $bagian = Bagian::all();
        return view('admin.pengguna.peserta.add')->with(['bagian' => $bagian]);
    }
    ...
    {
        $data = User::with(['peserta.divisi'])->findOrFail($id);
        $bagian = Bagian::all();
        return view('admin.pengguna.peserta.edit')->with(['data' => $data, 'bagian' => $bagian]);
    }

...
Route::group(['prefix' => 'peserta'], function () {
    ...
    Route::match(['post', 'get'], '/{id}/detail', [\App\Http\Controllers\Admin\PesertaController::class, 'detail']);
...
Route::group(['prefix' => 'laporan-peserta'], function () {
    ...
    Route::get('/data', [\App\Http\Controllers\Laporan\PesertaController::class, 'data']);
...
Route::group(['prefix' => 'laporan-pengajuan'], function () {
    Route::get('/', [\App\Http\Controllers\Laporan\PengajuanController::class, 'index']);
    Route::get('/data', [\App\Http\Controllers\Laporan\PengajuanController::class, 'data']);
    Route::get('/cetak', [\App\Http\Controllers\Laporan\PengajuanController::class, 'cetak']);
});
